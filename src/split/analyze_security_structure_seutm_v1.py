# -*- coding: utf-8 -*-
"""
보안장비 원본 구조 분석 → security_structure_report_seutm_v1.txt (seutm_v1)
- 스위치와 동일 로직, 대전: DJE_SEUTM_LIST.xlsx
"""
import openpyxl
import os

BASE_DIR = os.path.dirname(os.path.abspath(__file__))
# 충남: SOURCE = os.path.join(BASE_DIR, "CNE_SEUTM_LIST.xlsx")
SOURCE = os.path.join(BASE_DIR, "DJE_SEUTM_LIST.xlsx")
OUTPUT = os.path.join(BASE_DIR, "security_structure_report_seutm_v1.txt")
